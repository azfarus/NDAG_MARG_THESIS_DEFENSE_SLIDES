...
\begin{columns}[T, totalwidth=\textwidth]
  ...
  % Left column: Real World Applications
  ...
  % Right column: IMU and MARG Sensors
...
\begin{block}<1->{General Equation of the Weighted Sum}
  \[
...
\begin{columns}<2->[T,onlytextwidth]
  % Left: Advantages
  \begin{column}{0.48\textwidth}
    \begin{exampleblock}{\textbf{Advantages}}
      \begin{itemize}
  ...
  \begin{column}<3->{0.48\textwidth}
    \begin{exampleblock}{\textbf{Disadvantages}}
      \begin{itemize}
        \item Fixed filter gains cannot adapt to changing dynamics or sensor conditions.
        \item Gyroscope biases over time introduce drift if not perfectly zeroed.
...
\begin{columns}[T]
  ...
  \begin{column}{0.48\textwidth}
    \begin{exampleblock}<5->{{Movement Prediction \& $\alpha$ Toggling} \cite{vertzberger2022adaptive}}
      \begin{itemize}[<+->]
...
\begin{minipage}{\textwidth}
  \centering
  \scriptsize
  \captionof{table}{Quasi-Static error metrics (°) in Z-axis}
...
\begin{minipage}{0.5\textwidth}
  ...
  \captionof{figure}{Quasi-Static Error with Denoising (Z-axis)}
\end{minipage}%
\hfill
\begin{minipage}{0.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{graphs/qs_no_ml_z.png}
  \captionof{figure}{Quasi-Static Error without Denoising (Z-axis)}
\end{minipage}
...
\begin{minipage}{\textwidth}
  \centering
  \scriptsize
  \captionof{table}{Dynamic error metrics (°) in X-axis}
  \label{tab:dynamic_x}
  \begin{tabular}{lccccc}
    \toprule
    Metric & Prop. (ML) & Prop. (no ML) & Madg. & Aqua & EKF \\
...
\begin{minipage}{0.5\textwidth}
  ...
  \captionof{figure}{Dynamic Error with Denoising (X-axis)}
\end{minipage}%
\hfill
\begin{minipage}{0.5\textwidth}
  \centering
  \includegraphics[width=\linewidth,height=0.35\textheight]{graphs/dynamic_no_ml_x.png}
  \captionof{figure}{Dynamic Error without Denoising (X-axis)}
\end{minipage}
...
\begin{minipage}{\textwidth}
  \centering
  \scriptsize
  \captionof{table}{Dynamic error metrics (°) in Z-axis}
  \label{tab:dynamic_z}
  \begin{tabular}{lccccc}
    \toprule
    Metric & Prop. (ML) & Prop. (no ML) & Madg. & Aqua & EKF \\
...
\begin{minipage}{0.5\textwidth}
  ...
  \captionof{figure}{Dynamic Error with Denoising (Z-axis)}
\end{minipage}%
\hfill
\begin{minipage}{0.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{graphs/dynamic_no_ml_z.png}
  \captionof{figure}{Dynamic Error without Denoising (Z-axis)}
\end{minipage}
...
\begin{minipage}{\textwidth}
  \centering
  \scriptsize
  \captionof{table}{Static error metrics (°).}
  \label{tab:static_ml}
  \begin{tabular}{lccccc}
    \toprule
    Metric & Prop. (ML) & Prop. (no ML) & Madg. & Aqua & EKF \\
...
\begin{minipage}{0.5\textwidth}
  ...
  \captionof{figure}{Static Error with Denoising}
\end{minipage}%
\hfill
\begin{minipage}{0.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{graphs/static_no_ml.png}
  \captionof{figure}{Static Error without Denoising}
\end{minipage}
...
\begin{minipage}{\textwidth}
  \centering
  \scriptsize
  \captionof{table}{Quasi-Static error metrics (°) in X-axis}
...
\begin{minipage}{0.5\textwidth}
  ...
  \captionof{figure}{Quasi-Static Error with Denoising (X-axis)}
\end{minipage}%
\hfill
\begin{minipage}{0.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{graphs/qs_no_ml_x.png}
  \captionof{figure}{Quasi-Static Error without Denoising (X-axis)}
\end{minipage}
...
\begin{minipage}{\textwidth}
  \centering
  \scriptsize
  \captionof{table}{Quasi-Static error metrics (°) in Y-axis}
...
\begin{minipage}{0.5\textwidth}
  ...
  \captionof{figure}{Quasi-Static Error with Denoising (Y-axis)}
\end{minipage}%
\hfill
\begin{minipage}{0.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{graphs/qs_no_ml_y.png}
  \captionof{figure}{Quasi-Static Error without Denoising (Y-axis)}
\end{minipage}
...
\begin{minipage}{\textwidth}
  \centering
  \scriptsize
  \captionof{table}{Dynamic error metrics (°) in Y-axis}
  \label{tab:dynamic_y}
  \begin{tabular}{lccccc}
    \toprule
    Metric & Prop. (ML) & Prop. (no ML) & Madg. & Aqua & EKF \\
...
\begin{minipage}{0.5\textwidth}
  ...
  \captionof{figure}{Dynamic Error with Denoising (Y-axis)}
\end{minipage}%
\hfill
\begin{minipage}{0.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{graphs/dynamic_no_ml_y.png}
  \captionof{figure}{Dynamic Error without Denoising (Y-axis)}
\end{minipage}
